<template>
  <div class="min-h-screen bg-gray-100 px-6 pb-16 pt-24">
    ...
    <div v-if="!hotelDetail" class="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 class="mt-4 text-xl font-semibold text-gray-800">Hotel Not Found</h2>
      <p class="mt-2 text-sm text-gray-500">The hotel you are trying to book does not exist.</p>
    ...
    <div v-else-if="bookingConfirmed && lastBooking" class="mx-auto max-w-2xl">
      <div class="rounded-2xl bg-white p-8 text-center shadow-md">
        ...
        <h1 class="mt-5 text-3xl font-bold text-gray-800">Thank You!</h1>
    ...
    <div v-else class="mx-auto max-w-3xl">
        ...
        <div class="flex flex-col items-center gap-5 p-6 sm:flex-row">
          ...
          <div>
            ...
            <p class="mt-1 flex items-center gap-1 text-sm text-yellow-500">
              ...
              <span class="text-gray-500">({{ hotelDetail.reviewer }} reviews)</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mt-6 rounded-2xl bg-white p-6 shadow-md sm:p-8">
        <h2 class="mb-5 text-xl font-semibold text-gray-800">Guest Information</h2>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <!-- Room Type -->
          <div>
            <label for="roomType" class="block text-sm font-semibold text-gray-700">Room Type</label>
            <select
              id="roomType"
              v-model="roomType"
              class="mt-2 block w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-900 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-100"
          ...
          <!-- Guests -->
          <div>
            <label for="guests" class="block text-sm font-semibold text-gray-700">Guests</label>
            <input
              id="guests"
            ...
            <p v-if="selectedRoom" class="mt-1 text-xs text-gray-500">
              Max {{ selectedRoom.capacity }} guests for this room
            </p>
          </div>
        ...
        <div class="mt-6 rounded-xl bg-blue-50 p-5">
          <div class="flex items-center justify-between text-sm text-gray-600">
            <span>{{ roomType }}</span>
            <span>${{ selectedRoom?.price ?? 0 }} / night</span>
          </div>
          <div class="flex items-center justify-between text-sm text-gray-600">
