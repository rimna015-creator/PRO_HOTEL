<template>
  <div class="px-6 pb-10 pt-24">
    ...
    <h1 class="text-center text-3xl font-bold text-blue-900">
      {{ t("Promotions & Festival Packages") }}
    </h1>

    <p class="mx-auto mt-3 max-w-2xl text-center text-sm text-blue-600">
    ...
    <div v-else class="flex flex-col items-center justify-center py-20 text-center">
      <i class="bi bi-ticket-perforated text-5xl text-blue-400"></i>
      <h2 class="mt-4 text-xl font-semibold text-blue-900">
        {{ t("No promotions right now") }}
      </h2>
      <p class="mt-2 text-sm text-blue-500">
        {{ t("Check back soon for new festival packages!") }}
      </p>
    </div>
